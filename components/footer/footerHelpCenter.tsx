    ...
    <>
      <div className="flex flex-col sm:w-full lg:w-full lg:flex-row">
        <div className="flex flex-col items-center justify-center gap-10 bg-black p-4 text-white md:gap-10 lg:w-1/2">
          <h1 className="px-10 text-center text-2xl font-semibold tracking-wider">
          ...
          <Button
            asChild
            className="w-1/3 rounded-full border border-myPrimary bg-white py-8 text-lg font-light text-myPrimaryDark hover:bg-myPrimaryDark hover:text-white lg:py-6"
