  ...
  return (
    <>
      <div className="flex flex-col sm:w-full lg:w-full lg:flex-row">
        <div className="flex flex-col items-center justify-center gap-10 bg-black p-16 text-white md:gap-10 lg:w-1/2">
        ...
        <div className="relative h-[340px] sm:h-[400px] md:h-[334px] lg:h-[600px] lg:w-1/2">
          <Image
